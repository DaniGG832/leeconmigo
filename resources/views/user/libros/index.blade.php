      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg  border-2 border-blue-400 " style="min-height: 80vh;">
        ...
        <div x-data="ordenar" class="px-4 ">
          ...
          <form id="ordenar" action="{{route('libros')}}">
            ...
            <select x-on:change="ordenar" name="sortBy" id="sortBy" class="px-12 bg-blue-50 border border-blue-200 text-gray-900 text-sm rounded-lg focus:ring-blue-300 focus:border-blue-300 block  p-2.5 ">
        ...
        <form id="formSearch" action="{{route('libros')}}"> 
          ...
          <div class="relative">
              ...
              <input value="{{Request::input('search')}}" name="search" type="search" id="search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-blue-50 focus:ring-blue-300 focus:border-blue-300"  placeholder="Search ">
              {{-- <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button> --}}
              <button type="submit" class="absolute top-0 right-0 p-4 text-sm font-medium text-white bg-blue-400 rounded-r-lg border border-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300">
