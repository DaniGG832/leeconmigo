...
<div class="mx-1">
  ...
  <form id="formSearch" action="{{route('libros')}}"> 
    ...
    <div class="relative w-72 mr-4">
      ...
      <input value="{{Request::input('search')}}" name="search" type="search" id="search" class="mt-1 block w-full p-3 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-300 focus:border-blue-300"  placeholder="Search ">
