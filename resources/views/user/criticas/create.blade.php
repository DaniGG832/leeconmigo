...
<x-invitado>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
      {{ __('Escribir crítica de '.$libro->titulo ) }}
    </h2>
  </x-slot>
            ...
            <div class="flex flex-col -mx-4  p-5" style="min-height: 20em">
              ...
              <div class="bg-blue-50 mb-5 border border-blue-300 rounded-t p-5">
                ...
                <form action="{{route('criticas.store',$libro)}}" method="post">
                  ...
                  class="block p-2.5 w-full text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Escriba aquí...">{{old('critica',$critica->descripcion)}}</textarea>
