...
<div class="mb-6">
  ...
  <input type="text" id="titulo_original" name="titulo_original" value="{{old('titulo_original',$libro->titulo_original)}}" 
...
<div class="mb-6">
  ...
  <input maxlength="10" type="text" id="ISBN10" name="ISBN10" value="{{old('ISBN10',$libro->ISBN10)}}"
  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="0000000000">
</div>
...
<div class="mb-6">
  ...
  <input type="text" id="titulo_original" name="ISBN13" value="{{old('ISBN13',$libro->ISBN13)}}" 
  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="0000000000000">
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3 ">
  ...
  <div class="mb-6 ">
    ...
    <input type="text" id="year" name="year" value="{{old('year',$libro->year)}}"
     class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
  </div>
  ...
  <div class="mb-6 ">
    ...
    <input type="text" id="n_pag" name="n_pag" value="{{old('n_pag',$libro->n_pag)}}" 
    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
  </div>
