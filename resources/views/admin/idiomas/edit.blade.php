          ...
          <div class="container mx-auto px-6 py-8">
            ...
            <div>
              ...
              <div class="flex ">
                ...
                <h3 class="text-3xl font-medium text-gray-700 mt-5">Añadir idioma </h3>
              ...
              <div class="flex flex-col mt-8">
                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                  <div class="p-4 inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    ...
                    <form class="p-10" action="{{ route('admin.idiomas.update', $idioma, true) }}" enctype="multipart/form-data" method="post">
                      ...
                      @method('put')
                             ...
                             <div>
                              ...
                              <input class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer " id="Imagen" type="file" name="img" accept="image/*" style="display: none" value="{{old('img',$idioma->img)}}">
                              {{-- <div id="pre" class="h-32 flex items-center ">
                                <label class="block mb-2 text-md font-medium text-gray-900 w-36 h-28 mt-1 pt-1 pl-1 bg-gray-50 rounded-lg border border-gray-300" for="Imagen"><img src="{{asset($idioma->img) }}" alt="" ></label>
                                {{-- <label class="block text-md font-medium text-gray-900" for="Imagen">click en la imagen para seleccionar otra.</label> --}}
                              {{-- </div>  --}}
      
                              
                              <div id="pre" class="h-32 flex items-center ">
                                <label for='Imagen'><img class='rounded-lg' src="{{$idioma->img ? asset($idioma->img) : asset('img/el-principito.jpg')}}" style= 'height: 7rem' for='Imagen'/></label>
                <br><label class="block mb-2 text-md font-medium text-gray-800 ml-2 " for="Imagen">Click en la imagen para seleccionar otra.</label>
                            ...
                            <div class="mb-6 mt-3">
                              ...
                              <input type="text" id="name" name="name" value="{{old('name',$idioma->name)}}" required class="block p-4 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-md focus:ring-blue-500 focus:border-blue-500">
                              @error('name')
                              <p class="text-red-500 text-sm mt-1">
                                {{ $message }}
                              </p>
                            ...
                            <textarea id="descripcion" name="descripcion" rows="4" required class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Escriba aquí...">{{old('descripcion',$idioma->descripcion)}}</textarea>
                            @error('descripcion')
                            <p class="text-red-500 text-sm mt-1">
                              {{ $message }}
                            </p>
