                ...
                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                  <div class="p-4 inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    ...
                    enctype="multipart/form-data" method="post">
                      ...
                      <input class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer" id="img" 
                      name="img" type="file" accept="image/*">

                      {{-- Titulo --}}
                      <div class="mb-6 mt-3">
                        <label for="name" class="block mb-2 text-md font-medium text-gray-900">Código</label>
                        <input type="text" id="name" name="name" value="{{old('name',$idioma->name)}}" required
                      ...
                      class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Escriba aquí...">{{old('descripcion',$idioma->descripcion)}}</textarea>
