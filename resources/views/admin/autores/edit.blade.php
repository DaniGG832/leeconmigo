        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 min-h-screen ">
              ...
              <div class="flex flex-col mt-8">
                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                  <div class="p-4 inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    ...
                    <form class="p-10" action="{{ route('admin.autores.update', $autor, true) }}" enctype="multipart/form-data" method="post">
                      ...
                      <div>
                        ...
                        <input class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer " id="Imagen" type="file" name="img" accept="image/*" style="display: none" value="{{old('img',$autor->img)}}">
                        {{-- <div id="pre" class="h-32 flex items-center ">
                          <label class="block mb-2 text-md font-medium text-gray-900 w-36 h-28 mt-1 pt-1 pl-1 bg-gray-50 rounded-lg border border-gray-300" for="Imagen"><img src="{{asset($autor->img) }}" alt="" ></label>
          ...
          <br><label class="block mb-2 text-md font-medium text-gray-800 ml-2 " for="Imagen">Click en la imagen para seleccionar otra.</label>
                      ...
                      <div class="mb-6 mt-3">
                        ...
                        <input type="text" id="name" name="name" value="{{old('name',$autor->name)}}" required class="block p-4 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-md focus:ring-blue-500 focus:border-blue-500">
                        @error('name')
                        <p class="text-red-500 text-sm mt-1">
                          {{ $message }}
                        </p>
                      ...
                      <textarea id="descripcion" name="descripcion" rows="4" required class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Escriba aquí...">{{old('descripcion',$autor->descripcion)}}</textarea>
                      @error('descripcion')
                      <p class="text-red-500 text-sm mt-1">
                        {{ $message }}
                      </p>
